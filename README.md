...
- The database file is created automatically, you don't need to set anything up manually
- Passwords are stored as plain text — we know this isn't secure for real apps, but this is a local academic project
- Debug mode is on by default so error messages show up while testing
